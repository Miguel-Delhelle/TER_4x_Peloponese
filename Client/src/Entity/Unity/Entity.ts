...
export class Entity{
  ...
  public appendOnTile(tile_row:number, tile_col:number){
    ...
    /*d3.select("#"+tile.$id).append()

    .attr("x",tile.$centerPt.$x)
