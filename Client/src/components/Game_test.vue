...
onMounted(() => {
  ...
  var __game = new Phaser.Game(config);
});
...
function preload ()
{
  this.load.image('tiles', '../../public/assets/tiled/tilesets/tmw_desert_spacing.png');
  this.load.tilemapTiledJSON('map', '../../public/assets/tiled/maps/desert.json');
}
